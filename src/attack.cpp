...
const std::map<std::string, Attack> & Attack::getAttacks() {
    ...
    static std::map<std::string, Attack> s_attacks {
        ...
        // Earth
        // Air
        {"Claw", Attack("Claw", AttackStats(Type(BaseType::Air), 35, 0, 0.9f))},
        // Plant
        ...
        {"Heal", Attack("Heal", AttackStats(Type(BaseType::Normal), 0, 0, 1.f, 1.f, 1.f, 1.f, 1.f, 1.f ,1.f ,0.5f))},
        {"Sting", Attack("Sting", AttackStats(Type(BaseType::Normal), 30, 0, 0.95f))},
        {"Intimidate", Attack("Intimidate", AttackStats(Type(BaseType::Normal), 0, 0, 0.95f, 0.8f))},
        // Ghost
