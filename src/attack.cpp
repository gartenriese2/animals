...
const std::map<std::string, Attack> & Attack::getAttacks() {
	...
	static std::map<std::string, Attack> s_attacks {
		...
		{"Glow", Attack("Glow", AttackStats({{"AtkMod",0.8f}}))},
		// Water
		...
		// Electro
		{"Short Circuit", Attack("Short Circuit", AttackStats(Type(BaseType::Electro), 60))},
		// Stone
		// Earth
		// Air
		...
		{"Disc Cannon", Attack("Disc Cannon", AttackStats(Type(BaseType::Technology), 50))},
